...
def courses(term=None):
    if term is None:
        term = "Spring " + str(datetime.datetime.now().year)
...
def api(idx=None):
    if(idx==None):
        ...
        jdata = Course.objects(courseID=idx)
...
@app.route("/user")
def user():
    #User(user_id=1, first_name="Guilherme", last_name="Hur", email="guilherme@uta.com", password="abc").save()
    #User(user_id=2, first_name="Mary", last_name="Jane", email="mary.jane@uta.com", password="123").save()
